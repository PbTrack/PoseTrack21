...
def tracked_test(df, track_ratios):
    del df  # unused
    return track_ratios[track_ratios > 0].count()

simple_add_func.append(tracked_test)
...
def create():
    ...
    m.register(tracked_test, formatter='{:d}'.format)
